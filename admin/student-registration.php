...
{
  $_SESSION['msg']="Error : Faculty  not Register";
}
}
?>
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="studentname" name="studentname" placeholder="Faculty Name" required />
  </div>

 <div class="form-group">
    <label for="studentregno">Faculty ID   </label>
    <input type="text" class="form-control" id="studentregno" name="studentregno" onBlur="userAvailability()" placeholder="Faculty ID   " required />
